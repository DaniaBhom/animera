  ...
  <v-container fluid>
    <v-footer>
      ...
      <v-card flat tile class="bg-black white--text text-center">
        <v-card-text class="white--text pt-0 d-none d-sm-flex">
          <table style="width: 100%" border="0px solid white">
            <tr style="height: 50px" align="left">
              ...
              <th style="width: 500px" align="right"></th>
            </tr>
            ...
            <tr style="height: 50px" align="left">
              <td rowspan="3">
                <v-card
                  class="bg-black white--text text-justify"
                  max-width="500px"
                >
                  <p class="description">
                    A Animera Soluções Digitais é uma empresa de criação de
                    sites profissionais, aplicações web e aplicativos. Nós
                    projetamos, desenvolvemos e gerenciamos sites de alto
                    impacto que geram leads, vendem produtos e contam histórias.
                  </p>
                </v-card>
              </td>
              <td align="right"></td>
        ...
        <v-card class="logo_xs">
          <v-card class="bg-black d-flex d-sm-none">
            <v-img
          ...
          <v-card-text class="copy white--text d-flex d-sm-none">
            <strong>Copyright©</strong> {{ new Date().getFullYear() }} —
            <strong>Animera Soluções Digitais</strong>
          </v-card-text>
        </v-card>

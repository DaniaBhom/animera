    ...
    <div>
      <v-container>
        <p class="block"><b>
          ...
          Mobile e SEO(Search Engine Optimization), customizados de acordo com a sua necessidade.
        </b></p>
        <p class="block"><b>
        ...
        <p class="block"><b><a href="../contact">Clique aqui</a> para entrar em contato e saber sobre como podemos ajudar o seu negócio.
        </b></p>
       </v-container>
    </div>
    <div class="block">
